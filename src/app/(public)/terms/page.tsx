    ...
    <div className="relative min-h-screen text-gray-900 dark:text-white">
      <main className="relative z-10 mx-auto max-w-5xl px-6 py-16 md:px-10 md:py-24">
        ...
        <div className="mb-12 text-center">
          <div className="mb-5 inline-flex rounded-full border border-teal-400/20 bg-teal-400/10 px-4 py-2 text-sm text-teal-600 dark:text-teal-300">
            Legal Information
          </div>
        ...
        <div className="rounded-3xl border border-gray-200 bg-white/90 p-6 shadow-xl backdrop-blur-xl md:p-10 dark:border-gray-800 dark:bg-[#0e1424]/80">
          ...
          <section className="mb-10">
            ...
            <Link
              href="/privacy"
              className="mt-4 inline-block text-teal-600 transition hover:text-teal-500 dark:text-teal-400 dark:hover:text-teal-300"
            >
