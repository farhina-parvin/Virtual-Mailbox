    ...
    <div className="relative min-h-screen text-white">
      <main className="relative z-10 mx-auto max-w-5xl px-6 py-16 md:px-10 md:py-24">
        ...
        <div className="mb-12 text-center">
          <div className="mb-5 inline-flex rounded-full border border-purple-400/20 bg-purple-400/10 px-4 py-2 text-sm text-purple-300">
        ...
        <div className="rounded-3xl border border-gray-800 bg-[#0e1424]/80 p-6 shadow-2xl backdrop-blur-xl md:p-10">
          ...
          {/* 3 */}
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold">3. Information Security</h2>
          ...
          {/* 5 */}
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold">5. Information Sharing</h2>
          ...
          {/* 8 */}
          <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold">8. Your Privacy Choices</h2>
