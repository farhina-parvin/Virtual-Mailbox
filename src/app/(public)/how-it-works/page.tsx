  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-white">
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-6 pt-16 pb-16 text-center md:pt-24 md:pb-24">
        ...
        <p className="mb-4 text-sm font-semibold tracking-[0.25em] text-teal-400 uppercase">
          Simple & Secure
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {steps.map((step) => {
            ...
            return (
              <div
                key={step.number}
                className="group relative overflow-hidden rounded-2xl border border-gray-800 bg-[#0e1424]/80 p-7 backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-teal-500/40 hover:shadow-[0_0_30px_rgba(20,184,166,0.08)]"
              >
                {/* Step Number */}

                <div className="absolute top-4 right-5 text-5xl font-black text-white/[0.035]">
                  {step.number}
                </div>
                ...
                <p className="mb-2 text-xs font-semibold tracking-widest text-teal-400">
                  STEP {step.number}
                </p>
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 pb-24">
        <div className="overflow-hidden rounded-3xl border border-gray-800 bg-gradient-to-br from-[#10192b]/90 to-[#0d1220]/90 p-8 backdrop-blur-xl md:p-12">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <Link
                href="/pricing"
                className="mt-7 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-teal-500 to-purple-600 px-6 py-3 font-medium transition hover:opacity-90"
              >
                View Plans
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 rounded-xl border border-gray-800 bg-[#0b0f19]/70 p-4">
                <CheckCircle2 className="h-6 w-6 shrink-0 text-teal-400" />

                <div>
                  <h3 className="font-semibold">Easy Online Management</h3>
              ...
              <div className="flex items-center gap-4 rounded-xl border border-gray-800 bg-[#0b0f19]/70 p-4">
                ...
                <div>
                  <h3 className="font-semibold">Secure Mail Management</h3>
              ...
              <div className="flex items-center gap-4 rounded-xl border border-gray-800 bg-[#0b0f19]/70 p-4">
                <Mail className="h-6 w-6 shrink-0 text-teal-400" />

                <div>
                  <h3 className="font-semibold">Convenient Mail Access</h3>
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 pb-24 text-center">
        ...
        <div className="mt-7 flex flex-col justify-center gap-4 sm:flex-row">
          <Link
            href="/signup"
            className="rounded-xl bg-gradient-to-r from-teal-500 to-purple-600 px-7 py-3 font-medium transition hover:opacity-90"
          >
            Create Your Account
          </Link>
          ...
          <Link
            href="/pricing"
            className="rounded-xl border border-gray-700 px-7 py-3 font-medium transition hover:bg-gray-900"
          >
            View Pricing
          </Link>
        </div>
